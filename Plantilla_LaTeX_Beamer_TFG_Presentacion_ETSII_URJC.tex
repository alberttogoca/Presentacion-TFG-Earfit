...
\begin{itemize}
  \item Es el proceso de identificar y asociar los elementos musicales con la forma en que se siente el sonido físicamente. \bigskip
...
\begin{frame}
  ...
  \centering
  \includegraphics[clip=true,width=\textwidth]{Design Thinking/LeanDesignAgile-small}\\
\end{frame}
...
\begin{frame}
  ...
  \framesubtitle{Proveen los Datos y Alguna Lógica a los Hooks y Context}
  \begin{itemize}
...
\begin{frame}
  ...
  \framesubtitle{Auditoría de Calidad de la Página Web (Web Vitals)}
  \centering
...
% ==================== DEMO ========================
\begin{frame}
  \frametitle{Video de demostración}
  \centering
  \includegraphics[clip=true,width=0.35\textwidth]{Conclusiones/EarfitQR}
\end{frame}
