...
%     \item \href{https://earfit.vercel.app/}{EARFIT} es una PWA basada en Next.js y TypeScript. \bigskip
...
\begin{itemize}
  \item Identificar y asociar los elementos musicales con el sonido. \bigskip
  \item Los músicos, productores y DJs pueden beneficiarse. \bigskip
  \item Permite sacar canciones más rápido, improvisar mejor y llevar al instrumento las melodías. \bigskip
  \item Los ejercicios más comunes incluyen identificar notas, intervalos, escalas... \bigskip
\end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Incluir varios instrumentos para practicar con sus sonidos. \bigskip
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  ...
  \framesubtitle{Design Thinking, Lean Startup, Scrum y DevOps}
  \centering
  \includegraphics[clip=true,width=\textwidth]{LeanDesignAgile}\\
\begin{itemize}
  \item \textbf{Técnicas}: User Persona, MindMap, MoSCoW, Mobile First...
\end{itemize}
...
\begin{frame}
  \frametitle{Scrum}
  \framesubtitle{Proceso de Gestión del Desarrollo Ágil}
  \centering
  \includegraphics[clip=true,width=\textwidth]{Scrum/Scrum}\\
  \begin{itemize}
    \item \textbf{Artefactos}: User Story Map, Scrum Board y User Stories. \bigskip
  \end{itemize}
  \end{frame}

% \begin{frame}
%   \frametitle{Proceso de Gestión}
%   %\framesubtitle{User Story Map, Scrum Board y User Stories}
%   \begin{itemize}
%     \item \textbf{User Story Map}: Definir el viaje del usuario en el producto. \smallskip 
%       \begin{itemize}
%         \item User Activities. \smallskip
%         \item User Tasks. \smallskip
%         \item User Stories. \bigskip
%       \end{itemize}
%     \item \textbf{Scrum Board}: Visualizar el trabajo y gestionar el desarrollo. \smallskip
%       \begin{itemize}
%         \item Product Backlog. \smallskip
%         \item Sprint Backlog. \bigskip
%       \end{itemize}
%     \item \textbf{User Stories}: Requisitos desde la perspectiva del usuario. \smallskip
%     \begin{itemize}
%       \item Cómo [rol] quiero [acción] para [objetivo]. \smallskip
%       \item Criterios de Aceptación. \bigskip
%     \end{itemize}
%   \end{itemize}
% \end{frame}
...
\begin{frame}
  ...
  \centering
  \includegraphics[clip=true,width=0.6\textwidth]{DevOps/DPS}\\ \bigskip
    \begin{itemize}
      \item \textbf{Integración Continua (CI)}: Git, GitHub y GitFlow. \smallskip
      \item \textbf{Despliegue Continuo (CD)}: GitHub Actions, Vercel y DPS. \smallskip
    \end{itemize}
\end{frame}
% \begin{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{React}: Componentes, DOM Virtual, Sintaxis JSX... \bigskip
...
\begin{frame}
  ...
  \framesubtitle{Renderizan la Interfaz de Usuario}
  \centering
  \includegraphics[clip=true,width=\textwidth]{Detalles de Implementación/JerarquíaComponentes}\\
\end{frame}

\begin{frame}
  \frametitle{Hooks y Context}
  \framesubtitle{Encapsulan la Lógica de Estado}
  \begin{itemize}
...
\begin{frame}
  ...
  \framesubtitle{Proveen los Datos}
  \begin{itemize}
    \item \textbf{instrumentService.ts}: Provee los instrumentos de la aplicación. \bigskip
    \item \textbf{noteService.ts}: Provee las respuestas correspondientes al ejercicio de notas. \bigskip
    \item \textbf{intervalService.ts}: Provee las respuestas correspondientes al ejercicio de intervalos. \bigskip
    \item \textbf{scaleService.ts}: Provee las respuestas correspondientes al ejercicio de escalas. \bigskip
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{Infraestructura}
  \framesubtitle{Apoyan a los Servicios y la Interfaz}
  Tipos más importantes: \bigskip
  \begin{itemize}
    \item \textbf{Instrument}: Id, noteplayer, nombre para mostrar. \bigskip
    \item \textbf{Answer}: Id, array de notas, nombre para mostrar. \bigskip
  \end{itemize}
  Librerías más importantes: \bigskip
  \begin{itemize}
    ...
    \item \textbf{Soundfont-wrapper}: Simplificar “soundfont-player”. \\ Crear los Noteplayer para cada instrumento. \bigskip
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Progressive Web App}
  \framesubtitle{Instalable como App Nativa en PC, Móvil y Tablet}
  \begin{itemize}
    \item Conexión segura HTTPS. \bigskip
    \item Carga sin conexión, para ello tiene un Service Worker. \bigskip
    \item Información como nombre, autor, icono y descripción en un documento JSON llamado Manifest. \bigskip
    \item Icono de al menos 144x144 px en formato PNG. \bigskip
  \end{itemize}
\end{frame}
% \begin{frame}
...
\begin{frame}
  \frametitle{Software QA}
  \framesubtitle{Estándares y Calidad del Software}
  \begin{itemize}
    \item \textbf{Google Lighthouse}: Auditoría de Calidad. \\\bigskip
  \end{itemize}
  \includegraphics[clip=true,width=\textwidth]{Lighthouse/Resumen}\\ \bigskip
  % \begin{itemize}
  %   \item Datos de una simulación en el ordenador. \bigskip
  % \end{itemize}
  \begin{itemize}
    \item \textbf{Vercel Analytics}: Experiencia de Usuario (Web Vitals). \\\bigskip
  \end{itemize}
  \includegraphics[clip=true,width=\textwidth]{Vercel/VercelAnalytics-small}\\ \bigskip
  % \begin{itemize}
  %   \item Datos reales de los dispositivos de los usuarios reales. \bigskip
  % \end{itemize}
...
\begin{frame}
  ...
  \centering
  \movie[externalviewer]{\includegraphics[width=0.5\textheight, keepaspectratio]{Logos/Earfit2-play}}{Demo Earfit.mp4} \\ \bigskip
  URL: \href{https://earfit.vercel.app/}{\textcolor{blue}{https://earfit.vercel.app/}}
